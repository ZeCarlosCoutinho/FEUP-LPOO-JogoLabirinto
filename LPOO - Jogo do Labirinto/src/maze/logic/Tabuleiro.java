...
public class Tabuleiro {
	...
	/**
	 * @brief Coloca uma linha de espa�os no array 2D do tabuleiro
	 * @param c
	 * @param x
	 * @param y
	 * @param isHorizontal
	...
	/**
	 * @brief Torna um array 2D num quadriculado, e, que as linhas s�o alternadamente
	 * tudo cruzes, e cruzes alternadas com espa�os
	 */
