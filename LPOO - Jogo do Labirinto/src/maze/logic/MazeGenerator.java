...
public class MazeGenerator {
	...
	/**
	 * @brief Retorna saÃ­da do tabuleiro criado aleatoriamente
	 * @return SaÃ­da
	 */
	...
	public boolean temNaoVisitadaAdjacente(Celula cell)
	{
		...
		if(ySul < visitedCells.getTam()) //Se a cï¿½lula a sul estiver in bounds
		{
			try {
		...
		if(xEste < visitedCells.getTam()) //Se a cï¿½lula a este estiver in bounds
		{
			try {
	...
	public void abreCaminho()
	{
		...
		{
			abreCaminhoAteParar();
		}while(voltaAtrasCaminho()); //enquanto puder voltar atras no caminho, abre caminho atÃ© parar
